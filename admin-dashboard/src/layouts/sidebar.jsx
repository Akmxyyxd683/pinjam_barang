        ...
        >
            <div className="flex gap-x-3 p-3">
                <img
                    src={warungData}
                    alt="Warung data"
                    className="h-12 w-24 dark:hidden"
                />
                <img
                    src={warungData}
                    alt="Warung data"
                    className="hidden h-12 w-24 dark:block"
                />
                {!collapsed && <p className="text-lg font-medium text-slate-900 transition-colors dark:text-slate-50">Warung Data</p>}
            </div>
